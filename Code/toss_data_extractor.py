...
def extract():
    ...
    with open("OutputFiles/toss_data", "a", encoding='utf-8') as output_file:  # Open file in text mode
        for bug_id, assignments in assigned_to.items():
            ...
            if count >= 2:
                line += "\n"
                output_file.write(line)  # Write the line as string, no need to encode
